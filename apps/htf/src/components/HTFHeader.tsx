...
export default function HTFHeader() {
  return (
    <header className="sticky top-0 z-40 bg-htf-bg/80 backdrop-blur-xl border-b border-htf-border">
      <div className="max-w-5xl mx-auto flex items-center justify-between px-6 py-3">
        ...
        <a
          ...
          className="group flex items-center gap-2 text-htf-fg-subtle hover:text-htf-fg text-xs font-[family-name:var(--font-dm-sans)] tracking-wide transition-colors duration-300"
        >
